...
import org.virtual.thread.benchmark.test_implementations.addition_simulated_blocking.AdditionSimulatedBlockingTestSuite;
...
public class AdditionSimulatedBlockingTestFactory implements TestsFactoryCSV<Integer> {

    private final List<Integer> threadAmounts;
    private final TimeUnit timeUnit;

    public AdditionSimulatedBlockingTestFactory(List<Integer> threadAmounts, TimeUnit timeUnit) {
    ...
    public ThreadsTestSuite<Integer, List<String[]>> newTestSuiteInstance(String fileNamePrefix) throws Exception {
        return AdditionSimulatedBlockingTestSuite.newInstanceWithPrefixFileName(
                threadAmounts,
                timeUnit,
                fileNamePrefix
        );
    ...
    public String getTestName() {
        return AdditionSimulatedBlockingTestSuite.TEST_NAME;
    }
}
